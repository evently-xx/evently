...
class YelpEventPageParser(sgmllib.SGMLParser):
  ...
  def handle_data(self, value):
    if self.within_dt == True:
      if value == "Category:":
        self.item_type = self.ItemType.CATEGORY
      elif value == "When:":
        self.item_type = self.ItemType.TIME
      elif value == "Where:":
        self.item_type = self.ItemType.ADDRESS
      elif value == "How:":
        self.item_type = self.ItemType.HOW
      elif value == "Cost:":
        self.item_type = self.ItemType.COST
      elif value == "What/Why:":
        self.item_type = self.ItemType.DESCRIPTION
      return
    if self.item_type == self.ItemType.ADDRESS:
      if self.addr_attribute == "street-address":
        self.yelp_event.venueAddr = value
      elif self.addr_attribute == "locality":
        self.yelp_event.venueCity = value
      elif self.addr_attribute == "region":
        self.yelp_event.venueStateName = value
      elif self.addr_attribute == "postal-code":
        self.yelp_event.venueZip = value
