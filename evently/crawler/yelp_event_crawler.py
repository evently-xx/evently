...
print '''Usage: 
    - You need to run yelp_browse_crawler.py to store all the event URLs to the\
 YelpEventURL db first.\n\
    - This event crawlser only visits the event pages in the YelpEventURL db\
 to obtain useful event details.\n\
