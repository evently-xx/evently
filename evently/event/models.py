...
# User are created as one to one relation to the django build in user type.
...
# A ModelForm define how to create a form to modify this model.

class EventForm(ModelForm):
  class Meta:
    # This enable author created model form except below
    model = Event
    # We don't want the following feilds to be handled, yet.
    exclude = ('status', 'hosts', 'participators')
